                ...
                {localResults.map((med, idx) => {
                    ...
                    return (
                        ...
                        >
                            ...
                            {/* Always allow manual adjustment for all scans to ensure accuracy */}
                            <div className="mb-4 p-4 rounded-2xl bg-amber-50/20 dark:bg-amber-950/20 border border-amber-200/50 dark:border-amber-800 space-y-3">
                                <div className="flex items-center gap-2 mb-1">
                                    <AlertTriangle size={13} className="text-amber-500" />
                                    <p className="text-[10px] font-black text-amber-600 dark:text-amber-400 uppercase tracking-widest">
                                        Adjust schedule and stock if needed
                                    </p>
                                </div>
                                <div className="grid grid-cols-2 gap-3">
                                    <div>
