                ...
                return (
                    <Link
                        ...
                        className={cn(
                            ...
                            isActive ? "text-primary dark:text-orange-400 -translate-y-1" : "text-slate-400 dark:text-slate-500 hover:text-slate-600 dark:hover:text-slate-300"
                        )}
                    >
                        <item.icon
                            className={cn(
                                "w-6 h-6 transition-all",
                                isActive && "fill-orange-100 dark:fill-orange-500/30"
                            )}
