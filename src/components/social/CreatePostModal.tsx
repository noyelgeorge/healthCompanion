            ...
            <div className="w-full max-w-lg glass dark:glass-dark rounded-[2.5rem] overflow-hidden shadow-2xl border-white/40 dark:border-slate-800/50 animate-in slide-in-from-bottom-12 duration-500 max-h-[90vh] flex flex-col relative">
                ...
                <div className="p-6 border-b border-white/20 dark:border-slate-800/50 flex justify-between items-center shrink-0 relative z-10">
                    <div>
                        <h3 className="text-xl font-black text-slate-800 dark:text-white uppercase tracking-tight">
                            {postToEdit ? "Edit Post" : (postType === "recipe" ? "Add Recipe" : "Create Post")}
                        </h3>
                        <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mt-1">Create or Edit Post</p>
                    </div>
                    ...
                    <div className="space-y-6">
                        <div className="group">
                            ...
                            <input
                                ...
                                placeholder={postType === "recipe" ? "e.g. Protein Synthesis Bowl" : "Caption your post..."}
                            />
                        </div>

                        <div>
                            <label className="block text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] mb-3 ml-1">
                                {postType === "recipe" ? "Description" : "Details"}
                            </label>
                            <textarea
                                value={description}
                    ...
                    {postType === "recipe" && (
                        <div className="animate-in fade-in slide-in-from-top-4 duration-500">
                            <div className="flex items-center gap-3 mb-5">
                                ...
                                <h4 className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-400">Macros</h4>
                            </div>
                            <div className="grid grid-cols-2 gap-4">
                                <div className="group">
                                    <label className="block text-[8px] font-black text-slate-400 uppercase tracking-widest mb-2 ml-1">Calories (Kcal)</label>
                                ...
                                <div className="group">
                                    <label className="block text-[8px] font-black text-slate-400 uppercase tracking-widest mb-2 ml-1">Protein (G)</label>
                                    <div className="relative">
                                        <input
                                            type="number"
                                            value={protein}
                                ...
                                <div className="group">
                                    <label className="block text-[8px] font-black text-slate-400 uppercase tracking-widest mb-2 ml-1">Carbs (G)</label>
                                    <div className="relative">
                                        <input
                                            type="number"
                                            value={carbs}
                                ...
                                <div className="group">
                                    <label className="block text-[8px] font-black text-slate-400 uppercase tracking-widest mb-2 ml-1">Fat (G)</label>
                                    <div className="relative">
                                        <input
                                            type="number"
                                            value={fat}
                ...
                <div className="p-8 border-t border-white/20 dark:border-slate-800/50 shrink-0 bg-white/40 dark:bg-slate-900/40 backdrop-blur-xl relative z-10">
                    ...
                    >
                        ...
                        {isSubmitting ? (postToEdit ? "Updating..." : "Posting...") : (postToEdit ? "Save Changes" : (postType === "recipe" ? "Post Recipe" : "Post Photo"))}
                    </button>
                </div>
            </div>
        </div>
