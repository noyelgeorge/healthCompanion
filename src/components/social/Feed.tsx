    ...
    if (isLoading) {
        return (
            <div className="flex flex-col items-center justify-center py-24 relative overflow-hidden">
                ...
                <p className="text-slate-500 dark:text-slate-400 text-xs font-black uppercase tracking-[0.2em] mt-6 animate-pulse">Loading Feed...</p>
            </div>
        )
    }
    ...
    if (error) {
        return (
            <div className="text-center py-20 px-4 glass rounded-[2.5rem] mt-10">
                ...
                <h3 className="text-xl font-black text-slate-800 dark:text-white mb-2 uppercase tracking-tight">Failed to Load</h3>
            ...
            {posts.length === 0 ? (
                <div className="text-center py-20 px-6 glass rounded-[2.5rem] border-dashed border-slate-200 dark:border-slate-800 relative overflow-hidden">
                    ...
                    <div className="relative z-10">
                        ...
                        <h3 className="text-2xl font-black text-slate-800 dark:text-white mb-2 uppercase tracking-tight">Welcome to the Feed</h3>
