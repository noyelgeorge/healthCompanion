            ...
            <div className="relative z-10 flex flex-col items-center">
                <div className="relative group animate-cinematic-fade-in">
                    ...
                    <div className="p-[1px] rounded-[3.5rem] bg-gradient-to-b from-white/30 via-transparent to-transparent shadow-[0_0_50px_rgba(0,0,0,1)]">
                        <div className="w-68 h-68 flex items-center justify-center p-8 bg-[#000000] rounded-[3.4rem] border border-white/[0.08] relative overflow-hidden group-hover:border-cyan-500/30 transition-all duration-1000">
                ...
                <div className="mt-24 text-center animate-subtle-slide-up [animation-delay:0.4s]">
                    <div className="flex flex-col items-center space-y-6">
                        <div className="relative">
                            <h1 className="text-4xl font-light text-white tracking-[0.4em] uppercase leading-none mb-2">
                        ...
                        <p className="text-white/40 font-bold tracking-[1em] uppercase text-[9px] pt-4">
                            Precision Wellness
                        </p>
                    </div>
                </div>
                ...
                <div className="mt-32 flex flex-col items-center gap-4 animate-subtle-slide-up [animation-delay:0.8s]">
                    <div className="w-56 h-[1.5px] bg-white/[0.02] rounded-full overflow-hidden relative">
