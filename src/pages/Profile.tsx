                        ...
                        <form ref={formRef} onSubmit={handleSave} className="space-y-5 animate-in fade-in slide-in-from-top-2 duration-300">
                            <div className="grid grid-cols-1 gap-4">
                                <div>
                                    ...
                                    <input name="name" defaultValue={user.name} className="w-full h-14 mt-1 p-4 bg-white/50 dark:bg-slate-950/50 border border-slate-100 dark:border-slate-800 rounded-2xl text-slate-900 dark:text-white font-bold text-sm focus:outline-none focus:border-orange-500/50 focus:ring-4 focus:ring-orange-500/10 transition-all" />
                                </div>
                                <div>
                                    ...
                                    <input name="phoneNumber" defaultValue={user.phoneNumber} placeholder="+1234567890" className="w-full h-14 mt-1 p-4 bg-white/50 dark:bg-slate-950/50 border border-slate-100 dark:border-slate-800 rounded-2xl text-slate-900 dark:text-white font-bold text-sm focus:outline-none focus:border-orange-500/50 focus:ring-4 focus:ring-orange-500/10 transition-all" />
                                </div>
                                <div className="grid grid-cols-2 gap-4">
                                    <div>
                                        <label className="block text-[10px] font-black text-slate-400 uppercase tracking-widest mb-1.5 px-1">Weight (kg)</label>
                                        <input name="weight" type="number" step="0.1" defaultValue={user.weight} className="w-full h-14 mt-1 p-4 bg-white/50 dark:bg-slate-950/50 border border-slate-100 dark:border-slate-800 rounded-2xl text-slate-900 dark:text-white font-bold text-sm focus:outline-none focus:border-orange-500/50 focus:ring-4 focus:ring-orange-500/10 transition-all" />
                                    </div>
                                    <div>
                                        <label className="block text-[10px] font-black text-slate-400 uppercase tracking-widest mb-1.5 px-1">Age</label>
                                        <input name="age" type="number" defaultValue={user.age} className="w-full h-14 mt-1 p-4 bg-white/50 dark:bg-slate-950/50 border border-slate-100 dark:border-slate-800 rounded-2xl text-slate-900 dark:text-white font-bold text-sm focus:outline-none focus:border-orange-500/50 focus:ring-4 focus:ring-orange-500/10 transition-all" />
                                    </div>
                                </div>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            className="w-full h-14 mt-1 p-4 bg-white/50 dark:bg-slate-950/50 border border-slate-100 dark:border-slate-800 rounded-2xl text-slate-900 dark:text-white font-bold text-sm focus:outline-none focus:border-orange-500/50 focus:ring-4 focus:ring-orange-500/10 transition-all"
                                        />
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <select
                                            ...
                                            className="w-full h-14 mt-1 p-4 bg-white/50 dark:bg-slate-950/50 border border-slate-100 dark:border-slate-800 rounded-2xl text-slate-900 dark:text-white font-bold text-sm focus:outline-none focus:border-orange-500/50 focus:ring-4 focus:ring-orange-500/10 transition-all appearance-none cursor-pointer"
                                        >
                            ...
                            <div className="mt-4 p-4 bg-orange-500/5 dark:bg-orange-500/10 border border-orange-500/20 rounded-2xl flex items-center justify-between">
                                ...
                                <div className="text-right">
                                    <div className="text-4xl font-black text-orange-500">{dailyTarget}</div>
                                    <div className="text-[10px] text-orange-200 font-black uppercase tracking-widest">kcal / day</div>
                                </div>
                            </div>

                            <Button type="submit" fullWidth className="rounded-2xl h-14 font-black uppercase tracking-widest bg-slate-900 hover:bg-black text-white dark:bg-white dark:text-black dark:hover:bg-slate-100">Save Vitality</Button>
                        </form>
                    ) : (
                        <>
