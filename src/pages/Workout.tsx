...
export default function Workout() {
    ...
    const [selectedSuggestion, setSelectedSuggestion] = useState<ExerciseSuggestion | null>(null)
                    ...
                    {suggestions.map((s, i) => (
                        ...
                        >
                            ...
                            <button
                                ...
                                className="w-full py-3 mt-3 bg-emerald-500 text-white rounded-2xl font-black uppercase tracking-widest text-[11px] shadow-lg shadow-emerald-500/20 active:scale-[0.98] transition-all"
                            >
                                Log it
                            </button>
                        </div>
            ...
            {showExerciseModal && (
                <ExerciseModal
                    ...
                    onSubmit={async (name, type, minutes, intensity) => {
                        ...
                        await addExerciseEntry(today, {
                            name,
                            type,
                            durationMinutes: minutes,
                            intensity,
                            calories: Math.round(selectedSuggestion?.caloriesBurned || 0)
                        })
                        setShowExerciseModal(false)
                        setSelectedSuggestion(null)
                    ...
                    initialValues={selectedSuggestion ? {
                        ...
                        minutes: selectedSuggestion.duration,
